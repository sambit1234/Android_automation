...
public class Language {
	 ...
	 * click play button 
	 * wait for 6sec and click language button
	 * wait for 6sec
	 * click on Danish lang
	 * wait for 6sec
	 * subtitle off
	 * back
	 * Logout
	...
	//clicking on vdo for getting , language button
	driver.findElement(By.id(appcls+":id/exomedia_video_view")).click();	
	
	//clciking language
	driver.findElement(By.id(appcls+":id/subtitle_change_btn")).click();
	
	//clicking danish language
	driver.findElement(By.xpath("//android.widget.TextView[@text='Danish']")).click();
